package com.mashibing.msbdongbao.generator;
...
public class DongbaoGenerator {
	public static void main(String[] args) {
		...
		gc.setOutputDir("G:\\msb-dongbao-mall-parent\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
		gc.setAuthor("xcy");
		...
		dsc.setUrl("jdbc:mysql://192.168.200.131:3306/msb_dongbao_test?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
		...
		pc.setParent("com.mashibing.msbdongbaoums");
		pc.setEntity("entity");
		pc.setMapper("mapper");
